...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getProgramAccess().getAlternatives_2_1(), "rule__Program__Alternatives_2_1");
			...
			builder.put(grammarAccess.getSquareRootAccess().getGroup(), "rule__SquareRoot__Group__0");
			...
			builder.put(grammarAccess.getProgramAccess().getExternalAssignment_2_1_0(), "rule__Program__ExternalAssignment_2_1_0");
			builder.put(grammarAccess.getProgramAccess().getExternalAssignment_2_1_1(), "rule__Program__ExternalAssignment_2_1_1");
			builder.put(grammarAccess.getProgramAccess().getExternalAssignment_2_1_2(), "rule__Program__ExternalAssignment_2_1_2");
			...
			builder.put(grammarAccess.getSquareRootAccess().getNAssignment_1(), "rule__SquareRoot__NAssignment_1");
			builder.put(grammarAccess.getPowerAccess().getNAssignment_1(), "rule__Power__NAssignment_1");
			builder.put(grammarAccess.getPowerAccess().getMAssignment_3(), "rule__Power__MAssignment_3");
