...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass squareRootEClass = null;
   ...
   */
  @Override
  public EAttribute getProgram_External()
  {
   ...
   */
  @Override
  public EClass getSquareRoot()
  {
    return squareRootEClass;
  }
   ...
   */
  @Override
  public EReference getSquareRoot_N()
  {
    return (EReference)squareRootEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(programEClass, PROGRAM__EXTERNAL);
    ...
    squareRootEClass = createEClass(SQUARE_ROOT);
    createEReference(squareRootEClass, SQUARE_ROOT__N);

    powerEClass = createEClass(POWER);
    createEReference(powerEClass, POWER__N);
    createEReference(powerEClass, POWER__M);
  ...
  public void initializePackageContents()
  {
    ...
    squareRootEClass.getESuperTypes().add(this.getExpression());
    ...
    initEAttribute(getProgram_Program(), ecorePackage.getEString(), "program", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getProgram_External(), ecorePackage.getEString(), "external", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(squareRootEClass, SquareRoot.class, "SquareRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSquareRoot_N(), this.getExpression(), null, "n", null, 0, 1, SquareRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(powerEClass, Power.class, "Power", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPower_N(), this.getExpression(), null, "n", null, 0, 1, Power.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPower_M(), this.getExpression(), null, "m", null, 0, 1, Power.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
