...
public class MathAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MathSwitch<Adapter> modelSwitch =
    new MathSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSquareRoot(SquareRoot object)
      {
        return createSquareRootAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.SquareRoot <em>Square Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSquareRootAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.Power <em>Power</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
