...
public interface MathPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.SquareRootImpl <em>Square Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.SquareRootImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getSquareRoot()
   * @generated
   */
  int SQUARE_ROOT = 4;
   ...
   * @ordered
   */
  int SQUARE_ROOT__N = EXPRESSION_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Square Root</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SQUARE_ROOT_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.PowerImpl <em>Power</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.PowerImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getPower()
   * @generated
   */
  int POWER = 5;
   ...
   * @ordered
   */
  int POWER__N = EXPRESSION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int POWER__M = EXPRESSION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.Program#getProgram <em>Program</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Program</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Program#getProgram()
   * @see #getProgram()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.Program#getExternal <em>External</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EAttribute getProgram_External();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.Program#getMath <em>Math</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.SquareRoot <em>Square Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Square Root</em>'.
   * @see dk.sdu.mmmi.mdsd.math.SquareRoot
   * @generated
   */
  EClass getSquareRoot();

  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.SquareRoot#getN <em>N</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>N</em>'.
   * @see dk.sdu.mmmi.mdsd.math.SquareRoot#getN()
   * @see #getSquareRoot()
   * @generated
   */
  EReference getSquareRoot_N();

  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.Power <em>Power</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Power</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Power
   * @generated
   */
  EClass getPower();

  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.Power#getN <em>N</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>N</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Power#getN()
   * @see #getPower()
   * @generated
   */
  EReference getPower_N();

  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.Power#getM <em>M</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>M</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Power#getM()
   * @see #getPower()
   * @generated
   */
  EReference getPower_M();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute PROGRAM__EXTERNAL = eINSTANCE.getProgram_External();
    ...
    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.SquareRootImpl <em>Square Root</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.SquareRootImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getSquareRoot()
     * @generated
     */
    EClass SQUARE_ROOT = eINSTANCE.getSquareRoot();
     ...
     * @generated
     */
    EReference SQUARE_ROOT__N = eINSTANCE.getSquareRoot_N();

    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.PowerImpl <em>Power</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.PowerImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getPower()
     ...
     * @generated
     */
    EReference POWER__N = eINSTANCE.getPower_N();
     ...
     * @generated
     */
    EReference POWER__M = eINSTANCE.getPower_M();
